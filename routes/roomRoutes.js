...
router.post('/', asyncHandler(async (req, res) => {
  ...
  if (!roomNumber || !type) {
    ...
    req.flash('error', 'Room number and type are required.');
  ...
  if (existingRoom) {
    ...
    req.flash('error', 'Room number already exists. Please use a unique number.');
  ...
  req.flash('success', `Room ${newRoom.roomNumber} added successfully.`);
...
router.put('/:id', asyncHandler(async (req, res) => {
  ...
  if (duplicate) {
    ...
    req.flash('error', 'Another room with that number already exists.');
  ...
  req.flash('success', `Room ${room.roomNumber} updated successfully.`);
